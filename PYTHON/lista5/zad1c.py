...
class Wyrazenie:
    ...
    def __add__(self, w2):
        raise NotImplementedError("Metoda __add__() musi być zaimplementowana w podklasach.")

    def __mul__(self, w2):
        raise NotImplementedError("Metoda __mul__() musi być zaimplementowana w podklasach.")
